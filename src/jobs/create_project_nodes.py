...
def process(sc, job_args=None):
    ...
    prj_nodes_rdd.map(util.create).collect()
...
def create_platform_nodes(sql_context):
    ...
    platform_nodes.map(util.create).collect()
...
def create_language_nodes(sql_context):
    ...
    language_nodes.map(util.create).collect()
...
def create_status_nodes(sql_context):
    ...
    statuses_nodes.map(util.create).collect()
...
def create_license_nodes(sql_context):
    ...
    license_nodes.map(util.create).collect()
